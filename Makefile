GCC = /usr/bin/gcc
CFLAGS = -O2 -Wall -Wno-unused-function -Wno-unused-variable -no-pie `pkg-config --cflags --libs gtk+-3.0` -rdynamic -Wno-unused-result -pthread -ggdb -DGDK_DEBUG=nograbs
